...
class OrderModel {
  ...
  factory OrderModel.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return OrderModel(
      ...
      deliveryAddressDetails: parseDeliveryAddress(data['deliveryAddress']) ?? parseDeliveryAddress(data['deliveryAddressDetails']),
      pickupAddress: safeExtract<String>('pickupAddress', null) ?? '',
      pickupAddressDetails: parseDeliveryAddress(data['pickupAddress']) ?? parseDeliveryAddress(data['pickupAddressDetails']),
