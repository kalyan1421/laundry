...
class FcmService {
  ...
  void _handleNotificationTap(Map<String, dynamic> data) {
    ...
    if (notificationType == 'order_assignment' && data['orderId'] != null) {
      ...
      // Navigate to order details screen for admins
      navigatorKey.currentState?.pushNamed(
        '/order_details',
        arguments: data['orderId'],
      );
      ...
      navigatorKey.currentState?.pushReplacementNamed('/admin_home');
    } else {
      // Default navigation based on current user role
      // For delivery partners, go to delivery home
      // For admins, go to admin home
      navigatorKey.currentState?.pushReplacementNamed('/delivery-home');
    }
  }
